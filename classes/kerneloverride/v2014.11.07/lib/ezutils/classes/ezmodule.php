...
class eZModule
{
     ...
     */
    function __construct( $path, $file, $moduleName, $checkFileExistence = true )
    {
...
//        eZDebug::writeNotice( $params, 'module parameters1' );
    ...
    static function activeModuleRepositories( $useExtensions = true )
    {
        ...
        if ( $useExtensions )
        {
            ...
            // BEGIN BC : eZpedia : Kernel Hack : Make extension module view priority increase so that extension/ezpedia/modules/rss module can override the default kernel/rss module views
            $moduleRepositories = array_reverse( $moduleRepositories );
            // END BC : eZpedia : Kernel Hack : Make extension module view priority increase so that extension/ezpedia/modules/rss module can override the default kernel/rss module views
        }
